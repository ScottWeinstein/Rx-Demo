namespace RXDemo
{
    ...
    public class QuerySubscriptionDO : DependencyObject, IDisposable
    {
        ...
        public static readonly DependencyProperty QueryNameProperty = DependencyProperty.Register("QueryName", typeof(string), typeof(QuerySubscriptionDO), new UIPropertyMetadata(string.Empty));
